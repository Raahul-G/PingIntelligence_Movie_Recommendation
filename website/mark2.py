...
# loading data file
movie_df = pd.read_csv('C:/FV_2.0/MRS/Data/tmdb_5000_movies.csv', index_col=0)
credits_df = pd.read_csv('C:/FV_2.0/MRS/Data/tmdb_5000_credits.csv')
credits_df.columns = ['id', 'title', 'cast', 'crew']
credits_df = credits_df.drop(columns=['title'])
...
def movie_recommendation(user_title_1, user_title_2, cosine_sim=similarity):
    # getting input from user
...
>>>>>>> 48533a9a2b791cc2f6fb2ad96c7f9d3524016cda:mark2.py
